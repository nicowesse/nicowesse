...
if ( ! function_exists( 'the_paging_nav' ) ) :
/**
...
function the_post_nav() {
	...
	<nav class="post-navigation" role="navigation">
		<div class="nav-links">
		<?php
			next_post_link( '%link', __( '<span class="meta-nav next">←<span class="nav-title">%title</span></span>', 'twentyfourteen' ) );
			previous_post_link( '%link', __( '<span class="meta-nav prev"><span class="nav-title">%title</span>→</span>', 'twentyfourteen' ) );
		?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
